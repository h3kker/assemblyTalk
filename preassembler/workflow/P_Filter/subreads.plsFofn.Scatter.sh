...
########### TASK metadata #############
# Task        : subreads.plsFofn.Scatter
# Module      : P_Filter
# TaskType    : None
# URL         : task://Anonymous/P_Filter/subreads.plsFofn.Scatter
# createdAt   : 2013-12-20 15:55:42.524889
# ncmds       : 7
# LogPath     : /groups/csf-ngs/projects/20131203_Armin_PacbioEC/data/preassembly/result-nonsensitive/log/P_Filter/subreads.plsFofn.Scatter.log
# Script Path : /groups/csf-ngs/projects/20131203_Armin_PacbioEC/data/preassembly/result-nonsensitive/workflow/P_Filter/subreads.plsFofn.Scatter.sh
...
cat /groups/csf-ngs/projects/20131203_Armin_PacbioEC/data/preassembly/result-nonsensitive/workflow/P_Filter/subreads.plsFofn.Scatter.sh >> /groups/csf-ngs/projects/20131203_Armin_PacbioEC/data/preassembly/result-nonsensitive/log/P_Filter/subreads.plsFofn.Scatter.log;



echo 'Running task://Anonymous/P_Filter/subreads.plsFofn.Scatter on' `uname -a`;
...
# Task subreads.plsFofn.Scatter commands:
